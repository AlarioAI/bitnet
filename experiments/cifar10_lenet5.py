...
def run(seed: int | None) -> tuple[dict[str, float], Metrics, int, int]:
    ...
    train_loader, val_loader, test_loader, trainset_size = get_dataloaders(AvailableDatasets.CIFAR10, seed, batch_size)
    ...
    train_loader, val_loader, test_loader, _ = get_dataloaders(AvailableDatasets.CIFAR10, seed, batch_size)
