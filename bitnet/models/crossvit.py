...
from bitnet.models.crossvit_modules import Attention, PreNorm, FeedForward, CrossAttention
...
class CrossViT(nn.Module):
    def __init__(self, image_size, channels, num_classes, patch_size_small = 14, patch_size_large = 16, small_dim = 96,
                 ...
                 heads = 3, pool = 'cls', dropout = 0., emb_dropout = 0., scale_dim = 4, weights: None = None):
        super().__init__()
